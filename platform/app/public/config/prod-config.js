/** @type {AppTypes.Config} - DiagnoShare production environment */
...
window.config = {
  ...
  dataSources: [
    {
      ...
      sourceName: 'ohif',
      configuration: {
        friendlyName: 'Production DICOMWeb server',
        name: 'aws',
    ...
    },
    {
      ...
      sourceName: 'ohif2',
      configuration: {
        friendlyName: 'Production DICOMWeb secondary server',
        name: 'aws',
        wadoUriRoot: DICOMWEB_BASE_URL,
        qidoRoot: DICOMWEB_BASE_URL,
        wadoRoot: DICOMWEB_BASE_URL,
  ...
  httpErrorHandler: function (error) {
    ...
    console.warn('Production: check data source or network.');
  },
};
